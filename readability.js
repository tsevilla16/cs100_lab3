...
    db.run(`INSERT INTO textsinfo(fileHash, numbercount, lettercount, wordcount, sentencescount, colemanLiau, automatedReadabilty) VALUES(?,?,?,?,?,?,?)`, [fileHash, numberscount, letterscount, wordscount, sentencescount, colemanLiauNum, automatedReadabiltyNum], function(err) {
        if (err) {
